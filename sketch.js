...
function pleaWith1() {
  pleaButton = createButton("I am sorry Mr. forest demon");
  pleaButton.position(100, 580);
  pleaButton.size(160, 40);
...
function messWith1() {
  messButton = createButton("Um. You invaded MY privcy!");
  messButton.position(380, 580);
  messButton.size(160, 40);
...
function beginAdventure() {
  ...
  startButton.remove(); // -> remove "Begin Adventure!"
  background(bkgd1);
...
function demon8() {
  ...
  text("*I am the forest demon. You have invaded my privacy. I am angry*", txtX, txtY, 600);
  pleaWith1();
  messWith1();
...
function demon9() {
  ...
  text("You have made it worse. Now you die \nGAME   OVER", txtX, txtY, 600);
